...
[`server-auth`](server-auth.md), which adds Labkit access-token integration.
...
[`../../packages/server-graphql/README.md`](../../packages/server-graphql/README.md),
[`../../packages/server-graphql/src/index.ts`](../../packages/server-graphql/src/index.ts).
