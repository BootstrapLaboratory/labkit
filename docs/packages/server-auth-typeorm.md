...
[`../../packages/server-auth-typeorm/README.md`](../../packages/server-auth-typeorm/README.md),
[`../../packages/server-auth-typeorm/src/index.ts`](../../packages/server-auth-typeorm/src/index.ts).
