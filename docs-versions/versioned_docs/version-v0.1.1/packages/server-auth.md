...
[`../../packages/server-auth/README.md`](https://github.com/BootstrapLaboratory/labkit/blob/v0.1.1/packages/server-auth/README.md),
[`../../packages/server-auth/src/index.ts`](https://github.com/BootstrapLaboratory/labkit/blob/v0.1.1/packages/server-auth/src/index.ts).
