...
[`../../packages/server-config/README.md`](https://github.com/BootstrapLaboratory/labkit/blob/v0.1.1/packages/server-config/README.md),
[`../../packages/server-config/src/index.ts`](https://github.com/BootstrapLaboratory/labkit/blob/v0.1.1/packages/server-config/src/index.ts).
