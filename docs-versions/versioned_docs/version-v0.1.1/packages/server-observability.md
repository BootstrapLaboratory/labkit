...
[`../../packages/server-observability/README.md`](https://github.com/BootstrapLaboratory/labkit/blob/v0.1.1/packages/server-observability/README.md),
[`../../packages/server-observability/src/index.ts`](https://github.com/BootstrapLaboratory/labkit/blob/v0.1.1/packages/server-observability/src/index.ts).
