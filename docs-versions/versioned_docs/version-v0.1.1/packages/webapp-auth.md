...
[`../../packages/webapp-auth/README.md`](https://github.com/BootstrapLaboratory/labkit/blob/v0.1.1/packages/webapp-auth/README.md),
[`../../packages/webapp-auth/src/index.ts`](https://github.com/BootstrapLaboratory/labkit/blob/v0.1.1/packages/webapp-auth/src/index.ts).
